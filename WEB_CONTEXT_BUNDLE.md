...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-137-erd-s-problem-137-9c02e1c4-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-137"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-137-erd-s-problem-137-9c02e1c4-v1",
      "problem_contract_sha256": "d67fdcbd0f22b5ab43131423aa6a07289fe63decbe28ab61c14afb81f57d00ed",
      "problem_id": "problem:um-ep-137-erd-s-problem-137-9c02e1c4",
      "route_id": "route:um-ep-137-erd-s-problem-137-9c02e1c4-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-137-erd-s-problem-137-9c02e1c4-source-fidelity-01",
      "graph_id": "graph:um-ep-137-erd-s-problem-137-9c02e1c4-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-137-erd-s-problem-137-9c02e1c4-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-137-erd-s-problem-137-9c02e1c4-root",
          "statement": {
          ...
          "statement_sha256": "22014cbdc4c440ed0b52ddc98f3cefd21d7225d47722d8b803f6ea8a07c96a71"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-137-erd-s-problem-137-9c02e1c4-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-137-erd-s-problem-137-9c02e1c4-root",
      "route_id": "route:um-ep-137-erd-s-problem-137-9c02e1c4-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-137-4d6e9f9347ee",
        "url": "https://www.unsolvedmath.com/problems/EP-137"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
